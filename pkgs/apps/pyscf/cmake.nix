{ stdenv, lib, toPythonModule, cmake, fetchFromGitHub, writeTextFile, libcint, libxc, xcfun, blas,
  ...
  pyscf =
    stdenv.mkDerivation rec {
      ...
      installPhase = ''
        ...
        cp -r pyscf $out/lib/${python3.libPrefix}/site-packages/.

        mkdir -p $out/lib
        for lib in $out/lib/${python3.libPrefix}/site-packages/pyscf/lib/*.so ; do
          ln -s $lib $out/lib/.
        done
      '';
