...
|------|-----------|-------------|
| amd-fftw-3.0.1 | qchem.amd-fftw | Fastest Fourier Transform in the West library optimized for AMD Epyc CPUs |
...
| crest-2.11.1 | qchem.crest | Conformer-Rotamer Ensemble Sampling Tool based on the xtb Semiempirical Extended Tight-Binding Program Package |
...
| i-pi | qchem.i-pi | A universal force engine for ab initio and force field driven (path integral) molecular dynamics |
...
| Pegamoid-2.6.1 | qchem.pegamoid | Python GUI for OpenMolcas |
| psi4-1.4.1 | qchem.psi4 | Open-Source Quantum Chemistry – an electronic structure package in C++ driven by Python |
| pysisyphus-0.7.2 | qchem.pysisyphus | Python suite for optimization of stationary points on ground- and excited states PES and determination of reaction paths |
...
| spglib-1.16.2 | qchem.spglib | C library for finding and handling crystal symmetries |
