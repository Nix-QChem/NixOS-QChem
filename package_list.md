...
| gromacs-2022.2 | qchem.gromacsDouble | Molecular dynamics software package |
| gromacs-2022.2 | qchem.gromacsDoubleMpi | Molecular dynamics software package |
| gromacs-2022.2 | qchem.gromacsCudaMpi | Molecular dynamics software package |
| gromacs-2022.2 | qchem.gromacs | Molecular dynamics software package |
| gromacs-2022.2 | qchem.gromacsMpi | Molecular dynamics software package |
...
| hdf5-cpp-fortran-1.12.1 | qchem.hdf5-full | Data model, library, and file format for storing and managing data |
...
| libxc-5.2.2 | qchem.libxc | Library of exchange-correlation functionals for density-functional theory |
...
| octopus-11.4 | qchem.octopus | Real-space time dependent density-functional theory code |
...
| openmolcas-22.06 | qchem.molcas | Advanced quantum chemistry software package |
...
| psi4-1.6 | qchem.psi4 | Open-Source Quantum Chemistry – an electronic structure package in C++ driven by Python |
| pyPHSPU-2022-05-23 | qchem.autoint | Poly harmonic spline and partition of unity interpolation |
| pysisyphus-0.7.6.post2 | qchem.pysisyphus | Python suite for optimization of stationary points on ground- and excited states PES and determination of reaction paths |
...
| spglib-1.16.5 | qchem.spglib | C library for finding and handling crystal symmetries |
...
| ucc-1.0.0 | qchem.ucc | Collective communication operations API |
